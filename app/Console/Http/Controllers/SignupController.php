...
class SignupController extends Controller
{
    public function register(Request $request)
    {
        ...
        B::insert('insert into areas (street_name, street_no,house_no, customer_id,created_at) values (?, ?, ?, ?, ?)', [$request->streetName,$request->streetNo,$request->houseNo,$cusId->id,$today]);
